...
public class JFormattedTextFieldWithPlaceholder extends JFormattedTextField {
    private final String placeholder;

    public JFormattedTextFieldWithPlaceholder(String placeholder, AbstractFormatter format) {
        super(format);
