...
@Builder
public record McpResourcesUnsubscribeRequestModel(String method, Params params, String jsonrpc, Object id) implements iMcpRequest {
    @JsonCreator
    public McpResourcesUnsubscribeRequestModel(
